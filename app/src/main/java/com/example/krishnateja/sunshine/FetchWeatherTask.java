...
import com.example.krishnateja.sunshine.data.WeatherContract;
...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.key_units),
    ...
    protected String[] doInBackground(String... params) {
        ...
        try {
            ...
            String zip=pref.getString(mContext.getString(R.string.key_editpref), mContext.getString(R.string.default_value_editpref));
